...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PyramidsConfig::AbstractParamDescriptionConstPtr(new PyramidsConfig::ParamDescription<int>("pyramids_type", "int", 0, "Pyramids Type", "{'enum': [{'name': 'Up', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/Pyramids.cfg', 'description': 'Zoom In', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Down', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/Pyramids.cfg', 'description': 'Zoom Out', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Pyramids Types'}", &PyramidsConfig::pyramids_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/mustar/group13_ws/src/opencv_apps/cfg/Pyramids.cfg"
      const int Pyramids_Up = 0;
//#line 11 "/home/mustar/group13_ws/src/opencv_apps/cfg/Pyramids.cfg"
