...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HoughCirclesConfig::AbstractParamDescriptionConstPtr(new HoughCirclesConfig::ParamDescription<int>("debug_image_type", "int", 0, "Select image type for debug output", "{'enum': [{'name': 'Input', 'type': 'int', 'value': 0, 'srcline': 53, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg', 'description': 'Input image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Blur', 'type': 'int', 'value': 1, 'srcline': 54, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg', 'description': 'GaussianBlur image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Canny', 'type': 'int', 'value': 2, 'srcline': 55, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg', 'description': 'Canny edge image', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for debug view'}", &HoughCirclesConfig::debug_image_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 53 "/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg"
      const int HoughCircles_Input = 0;
//#line 54 "/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg"
      const int HoughCircles_Blur = 1;
//#line 55 "/home/mustar/group13_ws/src/opencv_apps/cfg/HoughCircles.cfg"
