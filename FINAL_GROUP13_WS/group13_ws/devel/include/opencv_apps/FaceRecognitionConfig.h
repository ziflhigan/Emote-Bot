...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FaceRecognitionConfig::AbstractParamDescriptionConstPtr(new FaceRecognitionConfig::ParamDescription<std::string>("model_method", "str", 0, "Method to recognize faces", "{'enum': [{'name': 'eigen', 'type': 'str', 'value': 'eigen', 'srcline': 41, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg', 'description': 'eigen', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'fisher', 'type': 'str', 'value': 'fisher', 'srcline': 42, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg', 'description': 'fisher', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'LBPH', 'type': 'str', 'value': 'LBPH', 'srcline': 43, 'srcfile': '/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg', 'description': 'LBPH', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Method to recognize faces'}", &FaceRecognitionConfig::model_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 41 "/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_eigen = "eigen";
//#line 42 "/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_fisher = "fisher";
//#line 43 "/home/mustar/group13_ws/src/opencv_apps/cfg/FaceRecognition.cfg"
